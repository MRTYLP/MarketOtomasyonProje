...
{
    public partial class Frm_Cek : Form
    {
        public Frm_Cek()
        {
            InitializeComponent();
        ...
        {
            if (txtAdSoyad.Text == "" || rchAdres.Text == "" || txtbankakimlik.Text == "")
            {
            ...
            else
            {
                ...
                SqlCommand komut = new SqlCommand("insert into Tbl_Satıslar (Tarih,AdSoyad,Adres,ÖdemeTürü,ÖdenenTutar) values (@p1,@p2,@p3,'Çek',@p5)", bgl.baglanti());
        ...
        private void Frm_Cek_Load(object sender, EventArgs e)
        {
