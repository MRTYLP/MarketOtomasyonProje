...
{
    public partial class Frm_Nakit : Form
    {
        public Frm_Nakit()
        {
            InitializeComponent();
        ...
        {
            if (txtAdSoyad.Text == "" || rchAdres.Text == "")
            {
            ...
            else
            {
                ...
                SqlCommand komut = new SqlCommand("insert into Tbl_Satıslar (Tarih,AdSoyad,Adres,ÖdemeTürü,ÖdenenTutar) values (@p1,@p2,@p3,'Nakit',@p5)", bgl.baglanti());
        ...
        private void Frm_Nakit_Load(object sender, EventArgs e)
        {
            bgl.baglanti();
